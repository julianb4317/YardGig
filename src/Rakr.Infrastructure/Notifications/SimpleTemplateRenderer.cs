...
public partial class SimpleTemplateRenderer : ITemplateRenderer
{
    private static readonly Dictionary<string, NotificationTemplate> Templates = new()
    {
        ...
        ["account.welcome"] = new(
            "Welcome to Rakr! 🌿",
            "<p>Hi {{userName}},</p><p>Welcome to Rakr! Your account has been created.</p><p>Please verify your email to get started.</p><p><a href=\"{{appUrl}}/verify?token={{confirmToken}}\">Verify Email</a></p>"),
